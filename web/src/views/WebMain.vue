  ...
  <div class="web-main">
    <el-header class="text-default bg-black px-0">
      <el-row>
        ...
        >
          <div
            class="author d-flex ai-center cursor-pointer noselect"
            @click="$router.push('/')"
          >
          ...
          <div class="music d-flex ai-center">
            ...
            <div
              class="right d-flex flex-wrap ac-between"
              style="width: 150px; height: 38px"
            >
              <div class="song-name text-14" style="width: 100%">
                {{ currentSong.name }}
              </div>
              <div
                class="play-controll d-flex jc-between cursor-pointer noselect"
                style="width: 60%"
              >
                <div class="iconfont" @click="lastSong">&#xe636;</div>
                <div class="iconfont" @click="isPlay = !isPlay">
                  {{ isPlay ? '&#xe776;' : '&#xe607;' }}
                </div>
                <div class="iconfont" @click="nextSong">&#xe637;</div>
              </div>
            </div>
            <div
              class="iconfont cursor-pointer noselect"
